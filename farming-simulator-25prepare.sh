...
#
# The game hardcodes its profile to "Documents/My Games/FarmingSimulator2025" under the user profile. Running
...
PROFILE="$DOCUMENTS/My Games/FarmingSimulator2025"
