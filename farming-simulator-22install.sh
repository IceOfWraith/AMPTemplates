#!/bin/bash
# Installs Farming Simulator 22 into the instance directory, for running under Proton.
...
if [[ -z "$DOWNLOAD_URL" ]]; then
    ...
    # Not anchored on /eshop/: newer titles are served from a per-product path instead.
...
echo "Downloading Farming Simulator 22. This is a multi-gigabyte download and will take a while"
...
SETUP=""
for n in Setup.exe FarmingSimulator2022.exe; do
